...
packages = %w{bash vim git nginx php5-common php5 php5-mysql php5-curl php5-mcrypt php5-cli php5-fpm php-pear curl imagemagick php5-imagick php5-xdebug php5-gd grub gdisk kpartx}
